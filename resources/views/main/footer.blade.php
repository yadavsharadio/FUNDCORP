            ...
            <div class="container footer-middle">
                <div class="row">
                    <div class="col-md-3 col-sm-3 footer-link1 xs-display-none">
                        <!-- headline -->
                        <h5>FundCorps Crowdfunding</h5>
                        <!-- end headline -->
                        <!-- text -->
                        <p class="footer-text">Fundcorps crowdfunding is focused on uniting corporate volunteers and NGO's to join hands and make a difference in society</p>
                        <!-- end text -->
                    </div>
